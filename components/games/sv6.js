...
function genSV6DefaultGameConfigObject(name) {
    ...
    const obj = {
        ...
        "code": friendCode,
        "sdvx_id": friendCode,
        "gamecoin_packet": user.blocks,
        "gamecoin_block": user.packets,
        "appeal_id": user.appeal,
        "last_music_id": user.musidID,
        "last_music_type": user.musicType,
        "sort_type": user.sortType,
        "headphone": user.headphone,
        "blaster_energy": user.blasterEnergy,
        "blaster_count": "0",
        "extrack_energy": user.extrackEnergy,
        "hispeed": "0",
        "lanespeed": "0",
        "gauge_option": "0",
        "ars_option": "0",
